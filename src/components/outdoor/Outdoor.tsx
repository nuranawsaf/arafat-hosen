...
const Outdoor = () => {
    ...
    return (
        <section>
            <div className='outdoor-bg h-[200px] md:h-[400px] lg:h-[809px]'>
                <h1></h1>
            </div>
            <div className='mx-[2rem] md:container'>
                <div className='mt-28 mb-20'>
                    <p className='text-justify text[13px] md:text-lg'>I love to do the outdoor painting for many reasons. One of the most common reasons is doing outdoor activities and being connected with nature, along with the fact that when painting outdoors. It helps me
                ...
                <div className='grid justify-center '>
                    ...
                    <p className='text-[14px] md:text-2xl font-semibold mt-4 mb-4' >watercolor at nursery, Diabari, Uttara</p>
                </div>
                <div className='grid md:grid-cols-2  md:gap-x-20 gap-y-16 mt-20 ' >
                    {outData.map((value,index) => {
                        return (
                            <div key={index} className='grid justify-center'>
                                <img src={value.url} alt="" />
                                <p className='text-[14px] md:text-2xl font-semibold mt-4 mb-4'>{value.info}</p>
                            </div>
                        )
                    })}
                </div>
                <p className='text-[13px] md:text-2xl font-normal mt-8 mb-24'>Few beautiful locations in Bangladesh from where I did some best outdoor paintings.</p>

                <div>
                    <h2 className='text-[24px] md:text-7xl'>Rangamati</h2>
                    <p className='text-justify text-[13px] md:text-2xl font-normal mt-8 mb-20'>Rangamati is a Beautiful location in Bangladesh, where mountains and the lack of water have touched the blue horizon! As one of my native students invite me to visit there for painting, I couldn’t refuse his
                    ...
                    <div className=' grid grid-cols-2 gap-x-4 md:gap-x-16 mt-4 md:mt-16 mb-16'>
                        <div className=' grid justify-center'>
            ...
            <div className='bg-gray-200 pt-1 pb-2 mb-16'>
                    <div className="mt-12 md:mt-40 px-[2rem] md:container">
                        <h2 className='text-[24px] md:text-7xl'>Old Dhaka</h2>
                        <p className='text-justify text-[13px] md:text-2xl font-normal mt-8 mb-20'>Few beautiful locations in Bangladesh from where I did some best outdoor paintings.</p>
